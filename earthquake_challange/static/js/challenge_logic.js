...
// Third tile layer
let nightNav = L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}', {
...
// Add layer groups for the tectonic plate data.
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson").then(function(data) {
  ...
  // This function determines the color of the marker based on the magnitude of the earthquake.
  function getColor(magnitude) {
    if (magnitude > 6) { return "#ea2c2c";}
    if (magnitude > 5) { return "#ea822c";}
    return "gray";
  }
...
d3.json("https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json").then(function(data) {  
    ...
    L.geoJson(data, {
      ...
      weight: 2,
      onEachFeature: function(feature,layer) {
        layer.bindPopup("<h3> Plate: " + feature.properties.Name + "</h3>")
      }
